...
\begin{frame}{Konzeption: Anforderungen an RTReconstruct}{}
    \begin{columns}[T]
        \column{0.5\textwidth}
        ...
        \begin{itemize}
            ...
            \item Parallelbetrieb mehrerer Modelle
            \item Multi-Client-Synchronisation
        \end{itemize}
        ...
        \begin{itemize}
            \itemsep0.8em
            \item Niedrige Latenz (VR-tauglich)
            \item Modularität \& Skalierbarkeit
            \item Stabilität bei Paketverlust
        \end{itemize}
    \end{columns}
    ...
    \begin{tcolorbox}[box5, boxsep=0.5em]
        \centering
        \textbf{Leitkriterien:} Echtzeitfähigkeit • Modularität • Integrationsfähigkeit
    \end{tcolorbox}
\end{frame}

\begin{frame}{Konzeption: Gesamtarchitektur}{(\cite{fette2011websocket,10.5555/2600239.2600241})}
    \centering
    \includesvg[width=0.9\textwidth]{figures/export/gesamtarchitektur}
\end{frame}

% \begin{frame}{Backend-Architektur: Router \& Worker}{(\cite{10.5555/2600239.2600241})}
%     \begin{columns}[T]
%         \column{0.5\textwidth}
%         {\large \textbf{Router}}
%         \begin{itemize}
...
% \begin{frame}{Konzeption: Modul- und Schnittstellendesign}{(\cite{josefsson2006rfc4648})}    
    
%     \begin{center}
%         \Large
%         \textbf{Binäres Kommunikationsprotokoll:}
%     \end{center}
...
%     \begin{tcolorbox}[box5, boxsep=0.5em]
%         \centering
%         \textbf{Vorteil:} unabhängige Vermittlungsschicht, sehr geringer Overhead
%     \end{tcolorbox}
% \end{frame}

\begin{frame}{Konzeption: Kommunikations- und Datenfluss}{}
    \begin{columns}[T]
