...
\begin{frame}{Konzeption: Gesamtarchitektur}{}
    \centering
...
\begin{frame}{Konzeption: Modul- und Schnittstellendesign}{}    
...
\begin{frame}{Konzeption: Kommunikations- und Datenfluss}{(\cite{fette2011websocket})}    
    \begin{columns}[T]
