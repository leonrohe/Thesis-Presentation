...
\begin{frame}{Grundlagen: Virtual Reality \& monokulare Rekonstruktion}{Zitationen hier}
...
\begin{frame}{Grundlagen: 3D-Rekonstruktion}{Zitationen hier}
    \textbf{Der Prozess:}
    \begin{itemize}
...
\begin{frame}{Grundlagen: 3D-Repräsentationsformate}{Zitationen hier}
    \begin{columns}[T]
        \column{0.5\textwidth}
        \textbf{Punktwolken}
        \begin{itemize}
...
\begin{frame}{Grundlagen: Zielumgebung Va.Si.Li-Lab}{Zitationen hier}
