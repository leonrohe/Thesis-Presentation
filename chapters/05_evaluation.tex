...
\begin{frame}{Evaluationsziele}{Zitationen hier}
...
\begin{frame}{Evaluationsumgebung}{Zitationen hier}
    \begin{columns}
        \column{0.5\textwidth}
...
\begin{frame}{Testszenarien}{Zitationen hier}
...
\begin{frame}{Funktionale Validierung - Ergebnisse}{Zitationen hier}
...
\begin{frame}{Performance-Analyse: Gesamtlatenz}{Zitationen hier}
    \begin{itemize}
...
\begin{frame}{Performance-Analyse: Latenz-Zusammensetzung}{Zitationen hier}
    \begin{itemize}
...
\begin{frame}{Performance-Analyse: Durchsatz}{Zitationen hier} 
    \begin{table}[h]
    \centering
...
\begin{frame}{Rekonstruktionsqualität: Quantitative Ergebnisse}{Zitationen hier}    
    \begin{table}[h]
    \centering
    \resizebox{\textwidth}{!}{
...
\begin{frame}{Rekonstruktionsqualität: Qualitative Bewertung}{Zitationen hier}
