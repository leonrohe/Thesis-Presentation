...
\begin{frame}{Testszenarien}{}
    \begin{figure}
        \begin{subfigure}{0.33\textwidth}
            \includegraphics[width=\textwidth]{images/room00.png}
        \end{subfigure}
        \hfill
        \begin{subfigure}{0.33\textwidth}
            \includegraphics[width=\textwidth]{images/Room01.png}
        \end{subfigure}
        \hfill
        \begin{subfigure}{0.33\textwidth}
            \includegraphics[width=\textwidth]{images/Room02.png}
        \end{subfigure}
        
        \begin{subfigure}{0.33\textwidth}
            \includegraphics[width=\textwidth, trim=0 0 0 20cm, clip]{images/room03.jpg}
        \end{subfigure}
        \begin{subfigure}{0.33\textwidth}
            \includegraphics[width=\textwidth, trim=0 0 0 20cm, clip]{images/room04.jpg}
        \end{subfigure}
    \end{figure}
\end{frame}
...
\begin{frame}{Performance-Analyse: Ressourcenauslastung}{}
    \textbf{Backend (Server):}
    \begin{itemize}
        \itemsep0.4em
        \item Router: Minimaler Overhead (2,5\% CPU, 100 MB RAM)
        \item Worker zeigen deutliche Unterschiede:
    \end{itemize}
    ...
    \begin{table}[h]
        ...
        \resizebox{\textwidth}{!}{
            \begin{tabular}{l|cc|cc}
                \textbf{Modell} & \textbf{GPU-Auslastung (\%)} & \textbf{Max. VRAM (GB)} & \textbf{CPU (\%)} & \textbf{RAM (GB)} \\
                \hline
    ...
    \textbf{Frontend (Meta Quest 3):}
    \begin{itemize}
        \itemsep0.4em
        \item Baseline: 72 FPS
        \item NeuralRecon: 72 FPS, VisFusion: 58 FPS
        \item SLAM3R, MASt3R-SLAM: 38 FPS
    \end{itemize}
\end{frame}
...
\begin{frame}{Rekonstruktionsqualität: V1}{}
    \centering
...
\begin{frame}{Rekonstruktionsqualität: V3}{}
    \centering
...
\begin{frame}{Rekonstruktionsqualität: R2}{}
    \centering
    ...
    \begin{minipage}[t]{0.45\textwidth}
        \centering
        \imgwithlabel{images/ReconsTransparent/room04/slam3r00.png}{SLAM3R}
    \end{minipage}
    \hspace{0.1cm}
    \begin{minipage}[t]{0.45\textwidth}
        \centering
        \imgwithlabel{images/ReconsTransparent/room04/mast3r00.png}{MASt3R}
    \end{minipage}
    \vfill
\end{frame}
