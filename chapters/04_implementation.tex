...
\begin{frame}{Technologie-Stack}{Zitationen hier}
    \begin{columns}[T]
        \column{0.5\textwidth}
...
\begin{frame}{Binäres Kommunikationsprotokoll}{Zitationen hier}
    \begin{columns}[T]
...
\begin{frame}{Backend-Implementierung: Router}{Zitationen hier}
...
\begin{frame}{Backend-Implementierung: Modell-Worker}{Zitationen hier}
...
\begin{frame}{Frontend-Implementierung: Hardware-Abstraktion}{Zitationen hier}
...
\begin{frame}{Frontend-Implementierung: Fragmentsammlung}{Zitationen hier}
...
\begin{frame}{Frontend-Visualisierung}{Zitationen hier}
    \begin{columns}[T]
        \column{0.5\textwidth}
        \textbf{Punktwolken}
        \begin{itemize}
...
\begin{frame}{Integration in Va.Si.Li-Lab}{Zitationen hier}
