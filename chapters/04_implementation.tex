...
\begin{frame}{Implementierung: Technologie-Stack}{\small \cite{ramirez2023fastapi, 10.5555/2600239.2600241, NVIDIAContainerToolkitDocs, endel2024nativewebsocket, atteneder2024gltfast, MetaPassthrough2021}}
    \begin{columns}[T]
        \column{0.5\textwidth}
...
\begin{frame}{Implementierung: Router}{}
    ...
    \begin{itemize}
        ...
        \item \textbf{/ws/model}: Modell-Worker registrieren sich, erhalten Fragment-Queues
    \end{itemize}
