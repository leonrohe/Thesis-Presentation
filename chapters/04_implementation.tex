...
\begin{frame}{Technologie-Stack}{\small \cite{ramirez2023fastapi, 10.5555/2600239.2600241, NVIDIAContainerToolkitDocs, endel2024nativewebsocket, atteneder2024gltfast}}
    \begin{columns}[T]
        \column{0.5\textwidth}
...
\begin{frame}{Binäres Kommunikationsprotokoll}{\cite{josefsson2006rfc4648}}
    \begin{columns}[T]
...
\begin{frame}{Frontend-Visualisierung}{\cite{atteneder2024gltfast}}
    \begin{columns}[T]
        \column{0.5\textwidth}
        \textbf{Punktwolken}
        \begin{itemize}
