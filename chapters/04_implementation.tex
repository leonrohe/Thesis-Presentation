...
\begin{frame}{Binäres Kommunikationsprotokoll}
    \begin{columns}[T]
        ...
        \begin{tcolorbox}[colback=blue!10, colframe=blue!70, boxsep=0.4em, title=\textbf{ModelFragment}]
            \small
            \centering
            \vspace{0.2em}
            Client $\to$ Server\\
        ...
        \column{0.33\textwidth}
        \begin{tcolorbox}[colback=teal!10, colframe=teal!70, boxsep=0.4em, title=\textbf{ModelResult}]
            \small
            \centering
            \vspace{0.2em}
            Server $\to$ Client\\
        ...
        \column{0.33\textwidth}
        \begin{tcolorbox}[colback=orange!10, colframe=orange!70, boxsep=0.4em, title=\textbf{TransformFragment}]
            \small
            \centering
            \vspace{0.2em}
            Client $\to$ Server\\
...
\begin{frame}{Frontend-Visualisierung}
    ...
    \begin{tcolorbox}[colback=yellow!5, colframe=gray!70, rounded corners, boxsep=0.5em]
        \small Beide Formate ohne externe Abhaengigkeiten, WebGL + Android (Meta Quest) kompatibel
    \end{tcolorbox}
\end{frame}
