...
\begin{frame}{3D-Rekonstruktion in VR}
...
\begin{frame}{Klassische Photogrammetrie: Ungeeignet}
    \begin{columns}[T]
        \column{0.5\textwidth}
        \textbf{Vorteile:}
        \begin{itemize}
...
\begin{frame}{Monokulare Echtzeit-Rekonstruktion: Potenzial \& Herausforderung}
    \textbf{Vorteile:}
    \begin{itemize}
