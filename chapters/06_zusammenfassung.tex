...
\begin{frame}{Echtzeitfähigkeit und GPU-Engpässe}{Zitationen hier}
    \begin{columns}[T]
        \column{0.5\textwidth}
...
\begin{frame}{Architektur: Containerisierung und Modularität}{Zitationen hier}
...
\begin{frame}{Rekonstruktionsqualität und SDK-Limitationen}{Zitationen hier}
    \begin{columns}[T]
        \column{0.5\textwidth}
...
\begin{frame}{Beantwortung der Forschungsfrage}{Zitationen hier}
    \begin{center}
...
\begin{frame}{Limitationen}{Zitationen hier}
    \begin{columns}[T]
        \column{0.5\textwidth}
...
\begin{frame}{Zukünftige Arbeiten}{Zitationen hier}
